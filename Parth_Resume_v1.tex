...
\headedsection  % sets the header for a subsection and contains usually body text
  ...
  \headedsubsection
    ...
    {\bodytext{
    \begin{itemize}
        \item Designed and developed SaaS based product as per client requirement.Worked in a team to deliver End-to-End development of software solutions across multiple stages of Software Development Life. 
